...
export default function EditName() {
  ...
  return (
    <>
      <NavBar />
      <main className="bg-accent text-cream w-full min-h-screen p-4 pt-10">
        ...
        >
          ...
          <button
            type="submit"
            className="text-accent justify-self-end bg-cream font-bold text-xl w-full lg:max-w-72 lg:py-1 py-2 font-mono hover:bg-white  md:py-4 md:text-xl"
