export default function TandC() {
	return (
		<main className="bg-accent min-h-screen p-8 lg:p-24 text-cream">
			<h1 className="text-5xl">Terms And Conditions</h1>

			<p>Last updated on Jan 23rd 2025</p>

			<p>
				For the purpose of these Terms and Conditions, the term{" "}
				<strong>&qoute;we&qoute;</strong>, <strong>&qoute;us&qoute;</strong>, <strong>&qoute;our&qoute;</strong>{""}
				used anywhere on this page shall mean <strong>Lovelin Test</strong>,
				whose registered/operational office is {""};
				<strong>
					3A/27, Kulakkarai 2nd Street, West Tambaram Kanchipuram TAMIL NADU
					600045
				</strong>
				. <strong>&qoute;You&qoute;</strong>, <strong>&qoute;your&qoute;</strong>,{""}
				<strong>&qoute;user&qoute;</strong>, <strong>&qoute;visitor&qoute;</strong> shall mean any
			...
			<p>
				...
				document without Lovelin Test’s prior written consent.
			</p>
