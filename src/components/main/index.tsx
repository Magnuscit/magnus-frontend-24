			...
			<div className="w-screen h-screen overflow-x-hidden">
				...
				<div className="w-full flex flex-col items-center justifycenter bg-cream2 font-space mix-blend-screen lg:min-h-screen space-y-10 py-10">
					...
					<div className="w-full flex-grow items-center flex justify-center flex-col px-5 relative md:min-h-[200px]">
						...
						<Polaroid image={"https://media.discordapp.net/attachments/1175463935269417051/1336647860376309861/IMG_2434.jpg?ex=67a491d3&is=67a34053&hm=91c43311dde46e6a86367e77a3dd1784539d81625997eec9f86de13395103370&=&format=webp&width=1258&height=1678"} _class=" md:absolute " description="CSE (AIML)" />
					</div>
          ...
          <a href="/events" className="bg-black text-cream px-20 py-3 font-bold rounded-sm">EVENTS</a>
				...
				<div className="w-full flex flex-col items-center justifycenter bg-cream2 font-space mix-blend-screen lg:min-h-screen space-y-10 py-10">
					...
					<div className="w-full flex-grow items-center flex justify-center flex-col px-5 relative md:min-h-[200px]">
						...
						<Polaroid image={"https://media.discordapp.net/attachments/1175463935269417051/1336647861328281622/IMG_7964.jpg?ex=67a491d3&is=67a34053&hm=157fbaf460d10b2e4c31ffbc537229ba280da24a9c4d9d2174001f20d3fb9c5f&=&format=webp&width=1258&height=1678"} _class=" md:absolute " description="MAGNUS" />
					</div>
