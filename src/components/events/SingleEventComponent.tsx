  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const hasRegisteredForEvent = userData.event_id.includes(
          eventData.title,
        );
    ...
    <main className="bg-cream font-space uppercase w-full min-h-screen p-10 px-5 lg:px-24 pt-24">
      <section className="event-header">
        <h1 className="lg:text-8xl text-5xl font-bold text-accent flex flex-col lg:flex-row space-y-5 lg:space-y-0 lg:space-x-5 ">
          ...
          <span className="bg-accent w-full text-white text-[50px] flex flex-col items-center justify-center font-bold text-center">
            {eventData.details.type}
          </span>
        </h1>
      ...
      <section className="lg:flex lg:space-x-10">
        <div className="event-registration w1/2">
          <h2 className="text-3xl mt-4 font-medium text-accent">
            REGISTRATION
          </h2>
          <ul>
